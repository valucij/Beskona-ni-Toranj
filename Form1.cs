...
namespace Beskonačni_Toranj
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //dodati slike enemya
           //enemy.addImage(Properties.Resources.coin);

            //dodati slike novcica
    ...
    private void restartGame()
        ...
        private void platformPictureBox_7_Click(object sender, EventArgs e)
        {
 ...
 * 
 * 
 * ---------------KOPIJA FORME S NESTAJUCIM PLATFORMAMA----------------------
namespace Beskonačni_Toranj
{
    public partial class Form1 : Form
    {
        ...
        private void platformTick()
        {
            ...
            foreach (Platform p in allPlatforms)
            {
                //ako je platforma u ekranu, micemo ju
                if (player.Y < 200 && !platformMoving) platformMoving = true;
